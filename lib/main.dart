...
Future<void> main() async {
  ...
  try {
    ...
    print("Warning: .env file not found or empty. $e");
  }
  runApp(const MyApp());
}
...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  final _codeController = TextEditingController(); // 確認コード用

  bool _isVerificationStep = false; // 「コード入力画面」を表示するかどうかのフラグ
      ...
      body: Padding(
        ...
        child: Center(
          child: _isVerificationStep
              ? _buildVerificationForm() // コード入力画面
              : _buildSignUpForm(), // 登録画面
        ),
      ),
    );
  }
